                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-info" role="alert">
                            ...
                            <ul>
                                <li>
                                    <span>Pendapatan diambil dari pembayaran instalasi dan tagihan customer.</span>
                                </li>
                                <li>
                                    <span>Untuk melihat total pendapatan bulanan atau tahunan silahkan ke <a
                                            href="{{ url('/') }}" class=" text-black">Dasbor</a>.</span>
                                </li>
                            </ul>
                        </div>
                        <div class="card">
                                ...
                                <div class="card-tools">
                                    <form action="" method="GET">
                                        <div class="input-group input-group-sm" style="width: 150px;">
                                            <select name="income_filter_month" class="form-control float-right">
                                            ...
                                            <select name="income_filter_year" class="form-control float-right">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger" data-toggle="modal"
                                                        data-target="#hapus-income{{ $data->id }}" title="Hapus">
